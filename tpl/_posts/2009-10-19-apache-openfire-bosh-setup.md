...
---
In order to use a [BOSH](http://xmpp.org/extensions/xep-0124.html)
What has to be done is to be able to connect your client to the BOSH adress of your jabber server.  
